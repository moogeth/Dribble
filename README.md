  ...
  <section id="about">
    <div class="container">
      <div class="row align-items-center">
        <div class="col-md-6">
          <img src="aboutus.jpg" class="img-fluid rounded shadow" alt="About image">
        </div>
        <div class="col-md-6">
          <h2>About Us</h2>
      ...
      <div class="row g-4">
        <div class="col-md-4">
          <div class="card border-0">
            <img src="mogi.jpg" class="shot-img w-100" alt="Shot 1">
            <div class="designer-meta">
              <div class="d-flex align-items-center gap-2">
                <img src="mogi.jpg" class="designer-avatar" alt="Avatar">
                <span class="fw-semibold">MOOGETH</span>
              </div>
              <span class="text-danger">❤️ 13082097</span>
            </div>
          </div>
        </div>
        <div class="col-md-4">
          <div class="card border-0">
            ...
            <div class="designer-meta">
              <div class="d-flex align-items-center gap-2">
                ...
                <span class="fw-semibold">inosuke</span>
              </div>
        ...
        <div class="col-md-4">
          <div class="card border-0">
            <img src="irai.jpg" class="shot-img w-100" alt="Shot 1">
            <div class="designer-meta">
              <div class="d-flex align-items-center gap-2">
                <img src="irai.jpg" class="designer-avatar" alt="Avatar">
                <span class="fw-semibold">irai</span>
              </div>
              <span class="text-danger">❤️ 13082007</span>
            </div>
          </div>
        ...
        <div class="col-md-4">
          <div class="card border-0">
            <img src="jedu.jpg" class="shot-img w-100" alt="Shot 2">
            <div class="designer-meta">
              <div class="d-flex align-items-center gap-2">
                <img src="jedu.jpg" class="designer-avatar" alt="Avatar">
                <span class="fw-semibold">atlas</span>
              </div>
        ...
        <div class="col-md-4">
          <div class="card border-0">
            <img src="hari.jpg" class="shot-img w-100" alt="Shot 3">
            <div class="designer-meta">
              <div class="d-flex align-items-center gap-2">
                <img src="hari.jpg" class="designer-avatar" alt="Avatar">
        ...
        <div class="col-md-4">
          <div class="card border-0">
            <img src="sai.jpg" class="shot-img w-100" alt="Shot 1">
            <div class="designer-meta">
              <div class="d-flex align-items-center gap-2">
                <img src="sai.jpg" class="designer-avatar" alt="Avatar">
        ...
        <div class="col-md-4">
          <div class="card border-0">
            <img src="dei.jpg" class="shot-img w-100" alt="Shot 1">
            <div class="designer-meta">
              <div class="d-flex align-items-center gap-2">
                <img src="dei.jpg" class="designer-avatar" alt="Avatar">
                <span class="fw-semibold">jedu</span>
              </div>
              <span class="text-danger">❤️ 13082007</span>
            </div>
          </div>
        ...
        <div class="col-md-4">
          <div class="card border-0">
            <img src="mano.jpg" class="shot-img w-100" alt="Shot 1">
            <div class="designer-meta">
              <div class="d-flex align-items-center gap-2">
                <img src="mano.jpg" class="designer-avatar" alt="Avatar">
                <span class="fw-semibold">tiger</span>
              </div>
              <span class="text-danger">❤️ 13082007</span>
            </div>
          </div>
        ...
        <div class="col-md-4">
          <div class="card border-0">
            <img src="death.jpg" class="shot-img w-100" alt="Shot 1">
            <div class="designer-meta">
              <div class="d-flex align-items-center gap-2">
                <img src="death.jpg" class="designer-avatar" alt="Avatar">
                <span class="fw-semibold">leomano</span>
              </div>
              <span class="text-danger">❤️ 13082007</span>
            </div>
          </div>
